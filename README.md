...
- `recipes` コレクション — `{ title, ingredients: [{name, amount, mark}], seasonings: [{name, amount, mark}], steps: [{headline, detail}], ingredientNames: string[], cookedDates: Timestamp[], createdAt, updatedAt }`
